 ...
 */
@ThreadSafe
public class StatisticsGatheringHttpClient extends AbstractStatisticsGatheringHttpClient {
     ...
     */
    public StatisticsGatheringHttpClient(
    ...
    public StatisticsGatheringHttpClient(final HttpParams params) {
        super(null, params);
    }
    ...
    /**
     * Creates the default set of HttpParams by invoking {@link StatisticsGatheringHttpClient#setDefaultHttpParams(HttpParams)}
     *
    ...
    public static void setDefaultHttpParams(HttpParams params) {
        ...
        final VersionInfo vi = VersionInfo.loadVersionInfo
            ("org.apache.http.client", StatisticsGatheringHttpClient.class.getClassLoader());
