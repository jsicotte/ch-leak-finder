...
import org.apache.http.impl.client.ConnectionStatistics.State;
 ...
 */
@NotThreadSafe
public class StatisticsAwareManagedEntity extends HttpEntityWrapper
    implements ConnectionReleaseTrigger, EofSensorWatcher {
	private HashMap<Integer,ConnectionStatistics> connectionStats;
     ...
     */
    public StatisticsAwareManagedEntity(HttpEntity entity,
                              ManagedClientConnection conn,
                              boolean reuse,
                              HashMap<Integer,ConnectionStatistics> connectionStats) {
        super(entity);
    ...
    protected void releaseManagedConnection()
        ...
        if (managedConn != null) {
        	synchronized (connectionStats) {
            	ConnectionStatistics stats = connectionStats.get(java.lang.System.identityHashCode(managedConn));
            	stats.setConnectionState(State.CLOSED);
            	stats.setLastUsed(System.currentTimeMillis());
            	//Log.debug("Connection closed: "+java.lang.System.identityHashCode(managedConn));
    		}
